...
export class ZuniswapV2Pair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class ZuniswapV2Pair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class ZuniswapV2Pair extends ethereum.SmartContract {
  static bind(address: Address): ZuniswapV2Pair {
    return new ZuniswapV2Pair("ZuniswapV2Pair", address);
  }
  ...
  burn(to: Address): ZuniswapV2Pair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to),
    ]);

    return new ZuniswapV2Pair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_burn(to: Address): ethereum.CallResult<ZuniswapV2Pair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new ZuniswapV2Pair__burnResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  getReserves(): ZuniswapV2Pair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new ZuniswapV2Pair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getReserves(): ethereum.CallResult<ZuniswapV2Pair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ZuniswapV2Pair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
